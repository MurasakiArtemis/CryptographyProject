...
static short ENCRYPTION_MODE=1;
	...
	/*private static char[] generate_key() 
	{
	int i;
	char[] key=new char[8];
	Random r=new Random();
	...
	private static key_set[] generate_sub_keys(char[] main_key) 
	{
	...
	public char[] process_message(char[] message_piece, char[] key, int mode) 
	{
...
//Class key_set, used to store the key for each round
class key_set
{
char k[];
char c[];
