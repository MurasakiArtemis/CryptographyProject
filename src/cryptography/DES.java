...
public class DES {
	...
	private int initial_key_permutaion[] = {57, 49,  41, 33,  25,  17,  9,
			1, 58,  50, 42,  34,  26, 18,
			10,  2,  59, 51,  43,  35, 27,
			19, 11,   3, 60,  52,  44, 36,
	...
	private int initial_message_permutation[] =	   {58, 50, 42, 34, 26, 18, 10, 2,
	...
	private int key_shift_sizes[] = {-1, 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1};

	private int sub_key_permutation[] =    {14, 17, 11, 24,  1,  5,
			3, 28, 15,  6, 21, 10,
			23, 19, 12,  4, 26,  8,
			16,  7, 27, 20, 13,  2,
			41, 52, 31, 37, 47, 55,
	...
	private int message_expansion[] =  {32,  1,  2,  3,  4,  5,
			4,  5,  6,  7,  8,  9,
			8,  9, 10, 11, 12, 13,
			12, 13, 14, 15, 16, 17,
			16, 17, 18, 19, 20, 21,
	...
	private int right_sub_message_permutation[] =  {16,  7, 20, 21,
			29, 12, 28, 17,
			1, 15, 23, 26,
			5, 18, 31, 10,
			2,  8, 24, 14,
	...
	private int final_message_permutation[] =  {40,  8, 48, 16, 56, 24, 64, 32,
	...
	private key_set[] generate_sub_keys(byte[] main_key) 
	{
	...
	void process_message(byte[] message_piece, byte[] processed_piece, int mode) 
	{
		int i, k;
		int shift_size;
		byte shift_byte;
		...
		for (k=1; k<=16; k++) 
		{
			...
			if (mode == DECRYPTION_MODE) key_index = 17 - k;
			else key_index = k;
